...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "19275802")
    API_HASH  = os.environ.get("API_HASH", "3d23613149060e13b80322415366fb3f")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7196362447:AAHiU_FqiwC2cQZZDsEXzU-G0i-_3FVkOPc") 
